...
- React/Vite Web 客户端与 Flutter 客户端；Flutter 支持 Android、macOS 和 HarmonyOS/OpenHarmony
...
scheduled task、askuser、模型与 capability 控制，当前平台工程覆盖 Android、macOS 与
HarmonyOS/OpenHarmony。Provider 配置仍由 Web 客户端或 HTTP API 管理。
...
- `flutter`：Android、macOS、HarmonyOS/OpenHarmony Flutter daemon 客户端
